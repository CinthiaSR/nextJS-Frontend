...
export const Usuarios = () => {
  ...
  return (
    <div>
      {/* titulo */}
      <div className="fixed flex items-center gap-2 p-2  lg:p-4 md:p-4 bg-gray-200 z-20 w-full">
        <span>
          <RiFileUserLine className="text-3xl" />
        </span>
        <h2 className="text-xl">Usuarios </h2>
      </div>
      <div className="flex flex-col md:flex-row gap-4 items-start p-3 pt-20 w-full">
        {/* formulario */}
        ...
        {/* table */}
        <div className="w-full md:w-[100%] lg:w-[70%] p-2  overflow-y-auto">
          <h1 className="text-xl">Lista de roles y permisos asignados</h1>
          <div className="overflow-x-auto pt-2 pb-2 pr-10">
